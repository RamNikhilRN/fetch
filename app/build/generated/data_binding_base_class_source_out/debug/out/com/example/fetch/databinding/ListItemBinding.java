...
package com.example.fetch.databinding;
...
public final class ListItemBinding implements ViewBinding {
  ...
  private ListItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static ListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ListItemBinding((ConstraintLayout) rootView, textView);
    }
